...
["loop"]() {
 ...
 // ===== THEME (safe) + multibox fill colors =====
const _0xT = window.__ZYNX_THEME__ || {};
...
// ngjyrat nga patch (fallback)
const _0xfillA = _0xT.cellActive || "#55d6ff";
const _0xfillB = _0xT.cellOther  || "#7cffb2";
