(() => {
    ...
    class _0x109239 {
      ...
      ["createElement"]() {
        if (!this.iframe) {
          ...
          this.iframe.src = this.iframePath.replace(/\/+$/, '');
    ...
    const _0x518936 = new class {
      ...
      ['drawLeaderboard']() {
        ...
        const _0x18b203 = document.getElementById('leaderboard-canvas');
        const _0x16162f = _0x18b203.getContext('2d');
      ...
      ["isInDisplay"](_0x293552, _0x12cf8f, _0x22cbe5) {
        const _0xb008fd = this.canvas.width / 0x2 / this.camera.viewScale;
        const _0x58e9fc = this.canvas.height / 0x2 / this.camera.viewScale;
    ...
    _0xa630e8.clients.forEach((client, index) => {
        ...
        (client.stores.cellsToRemove || []).forEach(cell => {
            if (!(cell.flags.isPellet && !_0x2395ab.settings.showPellets)) {
                cell.animate(_0xc209c9);
                this.removedCells.push(cell);
            }
        });

        (client.stores.cellsToRender || []).forEach(cell => {
            if (!(cell.flags.isPellet && !_0x2395ab.settings.showPellets)) {
                cell.animate(_0xc209c9);
                client.updateStaticBound(cell);

                if (!this.reverseCheckView(cell.targetX, cell.targetY, cell.size, index)) {
                    (cell.flags.isPellet ? this.pelletsFrame : this.cellsFrame).push(cell);
                }
            }
        });
    });
    ...
    // Sort cells
    if (this.cellsFrame.length)
        this.cellsFrame.sort((a, b) => a.size - b.size || a.id - b.id);

    // Camera & draw
    ctx.save();
    this.setCamera();
    if (_0x2395ab.settings.showSectors) this.drawSectors();
    this.drawMapBorder();

    [...this.removedCells, ...this.pelletsFrame, ...this.cellsFrame].forEach(cell => {
    ...
    if (_0x2395ab.settings.showDebug) {
    ...
    // Minimap & Leaderboard
    // drawMinimap/drawLeaderboard may need untransformed coordinates
    this.drawMinimap();
    this.drawLeaderboard();
}
...
["loop"]() {
    ...
    const _0x337cc2 = new class {
      ...
      ['getNickWidth'](_0x1e1958, _0x1861e8) {
        return this.nickShadowCtx.measureText(_0x1e1958).width * _0x1861e8 / 0x19;
      }
      ["getMassWidth"](_0x2b2cf4, _0xf666fa) {
        return this.massShadowCtx.measureText(_0x2b2cf4).width * _0xf666fa / 0x19;
      }
      ["getNewCanvas"]() {
  ...
  // âœ… CHANGE #1 (vetem ky vend): always white for your cells
...
// ======================================================
  ...
  if (!(this.flags.isPellet && this.flags.isEject && this.flags.isVirus)) {
    ...
    // âœ… CHANGE #2: border i hequr komplet (blloku i vjeter u fshi)
    ...
    const _0x2395ab = new class {
      ...
      ['initPlayerInputs']() {
        ...
        this.playerInfo.nickname = _0x3a6a1c.value = localStorage.getItem("ð™ð²ð§ð—:nickname") || '';
        this.playerInfo.tag = _0xdfd103.value = localStorage.getItem("ð™ð²ð§ð—:tag") || '';
        const _0x12d85a = localStorage.getItem("ð™ð²ð§ð—:server") || _0xeeb4e0.options[0x0].value;
        ...
        _0x3a6a1c.addEventListener("input", () => {
          ...
          localStorage.setItem('ð™ð²ð§ð—:nickname', _0x3a6a1c.value);
        });
        _0xdfd103.addEventListener("input", () => {
          ...
          localStorage.setItem("ð™ð²ð§ð—:tag", _0xdfd103.value);
        });
        _0xeeb4e0.addEventListener("change", () => {
          const _0x485497 = _0xeeb4e0.value;
          localStorage.setItem("ð™ð²ð§ð—:server", _0x485497);
      ...
      ['initSettings']() {
        this.settings = JSON.parse(localStorage.getItem('ð™ð²ð§ð—:settings')) || {
          'animationDelay': 0x8c,
      ...
      ["bindSlider"](_0x58fd39, _0x554ea3, _0x4b168c) {
        ...
        _0x145425.addEventListener("input", _0x6d5416 => {
          ...
          localStorage.setItem("ð™ð²ð§ð—:settings", JSON.stringify(this.settings));
        });
      }
    ...
    document.addEventListener("DOMContentLoaded", () => {
      console.log("Document is ready, initializing ð™ð²ð§ð— Engine...");
      _0x2395ab.start();
      _0x518936.start();
